...
const customStyles = {
 ...
 const closeModal = () => {
  ...
  return (
    <div className={darkMode? "header-main darkUI darkline" : "header-main"}>
      {/* <img
        src={logo}
        alt="instagram logo"
      ...
      <div className="hamburger-icon" >
        ...
        {darkMode? <BiSun onClick={()=>setDarkMode(false)}/> : <GoMoon onClick={()=>setDarkMode(true)}/>}
      ...
      <Modal
        ...
        contentLabel="logout"
      >
        <div className={darkMode? "logout-modal-content darktext" : "logout-modal-content"}>
      ...
      >
       <div className={darkMode ? "modal-content darktext" : "modal-content"}>
